                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                ...
                                <a href="bergabung_sekarang.php" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Bergabung Sekarang</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <a class="btn btn-primary py-3 px-5 mt-2" href="books.php">Jelajahi Koleksi</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="books.php">Koleksi Buku</a>
                </div>
                <div class="col-lg-3 col-md-6">
                    <h4 class="text-white mb-3">Kontak Kami</h4>
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Komplek Kompas Gramedia, Jakarta</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>(021) 53699200</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>customercare@gramedia.id</p>
                </div>
                <div class="col-lg-3 col-md-6">
