<head>
    ...
    <!-- Your custom CSS -->
    <link href="../../css/peminjam.css" rel="stylesheet">
...
<table id="myTable" class="table table-striped table-hover">
    ...
    <tbody>
        ...
        LEFT JOIN buku ON peminjaman.BukuID=buku.BukuID WHERE peminjaman.UserID='$_SESSION[user_id]'");
