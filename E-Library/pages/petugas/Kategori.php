...
<body>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="td-actions text-center">
                                        ...
                                        <button type="button" rel="tooltip" class="btn btn-success btn-round btn-just-icon btn-sm" data-original-title=""data-bs-toggle="modal" data-bs-target="#editModal<?= $data['KategoriID'] ?>" title="">
 ...
 <div class="modal fade" id="editModal<?= $data['KategoriID'] ?>" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            ...
            <!-- End of edit modal -->
                                    ...
                                    <button type="button" rel="tooltip" class="btn btn-danger btn-round btn-just-icon btn-sm" data-bs-toggle="modal" data-bs-target="#hapusModal<?= $data['KategoriID'] ?>" data-original-title="" title="">
