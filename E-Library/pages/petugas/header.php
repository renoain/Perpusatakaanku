  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
       ...
       <li>
        <a href="?pages=Kategori" class="nav-link" >
       Kategori
        </a>
      ...
      <li>
        ...
        <li class="nav-item">
          <a href="?pages=laporan" class="nav-link " aria-disabled="true">laporan</a>
          </li>
        <li class="nav-item">
          <a  href="?pages=user" class="nav-link " aria-disabled="true">user</a>
        </li>
